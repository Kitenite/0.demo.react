...
export const FilledOnStroke1Radius2JoinRound = ({ className }) => {
  return (
    <svg
      className={`filled-on-stroke-1-radius-2-join-round ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
