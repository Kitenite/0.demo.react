...
export const FilledOffStroke15Radius0JoinRound3 = ({ className }) => {
  return (
    <svg
      className={`filled-off-stroke-1-5-radius-0-join-round-3 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
